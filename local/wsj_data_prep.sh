...
if [ ! -d links/11-13.1 -o ! -d links/11-2.1 ]; then
...
# trigram would be:
cat links/11-13.1/wsj0/doc/lng_modl/base_lm/tcb20onp.z | \
...
cp links/11-13.1/wsj0/doc/lng_modl/base_lm/bcb05onp.z  $lmdir/lm_bg_5k.arpa.gz || exit 1;
chmod u+w $lmdir/lm_bg_5k.arpa.gz

# trigram would be: !only closed vocabulary here!
cp links/11-13.1/wsj0/doc/lng_modl/base_lm/tcb05cnp.z $lmdir/lm_tg_5k.arpa.gz || exit 1;
